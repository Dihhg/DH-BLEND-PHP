...
<body>
    ...
    <p>Foreach - o array(na verdade percorre somente array e objetos)</p>

    <p>Percorra o array de animais utilizando foreach com a sintaxe de posicao e valor,
    e retorne a seguinte frase "posicao:x indice:y",onde x e y serao substituidos pelas posicoes e indice de animais </p>
    <p style="padding: 5px;background-color:#f5f5f5;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
        $animais = ["Gato", "Cachorro", "Leão", "Girafa"];
    </p>
    ...
    <?php
    /* o foreach recebe um array ou objeto, no nosso caso iremos informar um array e sabemos que o foreach tem
    essa primeira sintaxe no formulato onde ele pega a posicao e o indice do elemento corrente */

    /* para cada elemento,cria a variavel $posicao contendo o valor da posicao daquele elemento percorrido dentro e tambem cria a
     variavel $indice  contendo o valor do indice do elemento percorrido dentro do array*/

    /* Ou seja no futuro ao execultar o codigo do foreach percorrendo o array de animais,
    teremos as variaveis posicoes e indice com estes valores abaixo 
         posicao | indice
         0       | gato
         1       | cachorro
         2       | Leao
    ...
    foreach ($animais as $posicao => $indice) {
        echo "posicao: " . $posicao . "indice" . $indice . "<br>";
    }
    ?>
...
<p>Percorra o array de animais utilizando foreach com a sintaxe de valor,</p>
<p style="padding: 5px;background-color:#f5f5f5;border-radius:10px;color:blue;line-height:20px;font-size:16px;">
    $animais = ["Gato", "Cachorro", "Leão", "Girafa"];
</p>
...
<?php
/* o foreach recebe um array ou objeto, no nosso caso iremos informar um array e sabemos que o foreach tem
essa segunda sintaxe no formulato onde ele pega apenas o indice do elemento corrente */

/* para cada elemento,cria a variavel $animal  contendo o valor do indice do elemento percorrido dentro do array*/

/* Ou seja no futuro ao execultar o codigo do foreach percorrendo o array de animais,
teremos as variaveis $animal com estes valores abaixo 
    indice
    gato
    cachorro
    Leao
